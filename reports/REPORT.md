...
Kiểm tra cấu trúc export: 9/9 task OK, đúng ảnh, class và dạng mask. Self-check với ground truth ba tier: easy_semantic 20.0/20, medium_instance 10.5/32, hard_panoptic 18.5/30, tổng 49.0/82. Sáu checkpoint chưa có ground truth nên chưa tính điểm.
